...
#   timestamp: 2025-06-28T15:07:12+00:00
...
class CertificateParameters(BaseModel):
    InsuredDob: str = Field(
        ..., description='Insured Date of Birth', examples=['DD/MM/YYYY']
    )
    PolicyNo: str = Field(
        ..., description='Policy Number', examples=['3001/51962270/00/000']
    )
